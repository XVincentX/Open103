...
public:
    ...
    /*Creates a dataunit. */
    IFT12_(const unsigned char Ctrl, const unsigned char Addr) : UserData(0), UserDataSize(0), Control(Ctrl), Address(Addr) {}
    ...
    IFT12_(const void *pData, const size_t Size) : UserData(0), UserDataSize(0)
    {
        ...
        if (ComputeChecksum() != CheckSum)
            TRACEENDL("Current checksum is not valid. This frame should be discarderd");
    ...
    inline static unsigned char CreateControlByte(const unsigned char PRM, const unsigned char FCB, const unsigned char FCV, const unsigned char F1, const unsigned char F2, const unsigned char F3, const unsigned char F4)
    {
